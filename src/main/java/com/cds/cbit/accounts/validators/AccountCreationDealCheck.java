...
*/
@Log4j2
@Component("accountDealCheck")
public class AccountCreationDealCheck implements TransactionValidator {

  private final BillingInfoSearchUtil searchUtil;

  public AccountCreationDealCheck(final BillingInfoSearchUtil searchUtil) {
  ...
  public FList validateInput(final String input,final PortalContext portal,final String... data)
    ...
    final FList output =  searchUtil.executeTransactionSearchTemplate(
                                     ConstantsUtil.DEAL_CHECK_SQL, arguments, results, portal);
