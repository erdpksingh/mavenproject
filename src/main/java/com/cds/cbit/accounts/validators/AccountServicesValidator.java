...
public class AccountServicesValidator implements BillingValidation {
  
  private final BillingInfoSearchUtil searchUtil;
  
  public AccountServicesValidator(final BillingInfoSearchUtil searchUtil) {
  ...
  public FList validateInput(final String input,final String... data) 
    ...
    final FList output = 
                    searchUtil.executeSearchTemplate(ConstantsUtil.SERVICE_SQL, arguments, results);
