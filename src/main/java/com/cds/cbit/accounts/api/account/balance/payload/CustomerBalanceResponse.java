...
/**
 * The POJO represents customer balance API response.
 * 
...
@NoArgsConstructor
@AllArgsConstructor
public class CustomerBalanceResponse implements Serializable,GenericResponse {
  
  private static final long serialVersionUID = -6174727322679654709L;
  
  private ResponseHeader head;
  
  private CustomerBalanceResponseBody body;
} // End of CustomerBalanceResponse.