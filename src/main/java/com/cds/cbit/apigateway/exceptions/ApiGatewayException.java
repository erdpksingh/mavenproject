...
/**
 * Custom exception for handling all API Gateway errors which occurs while processing the request 
 * in billing system.
 * 
...
public class ApiGatewayException extends RuntimeException {
  ...
  public ApiGatewayException(final Exception e) {
    super(e);
  } // End of Constructor
  
  public ApiGatewayException(final String message,final Exception e) {
    super(message,e);
  } // End of Constructor overloading with exception argument.
} // End of custom exception ApiGatewayException.